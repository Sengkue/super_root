      ...
      <div class="flex justify-between items-center px-4 py-3 gap-3">
        ...
        <div class="flex-1 relative">
          ...
          <input 
            ...
            @keyup.enter="handleSearch" 
            placeholder="Search..." 
            class="w-full bg-slate-700 border-none text-slate-200 text-sm rounded-full focus:ring-2 focus:ring-blue-500 block pl-9 p-2 transition-colors"
          >
        </div>

        <NuxtLink to="/menu" class="w-10 h-10 shrink-0 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 [&.router-link-active]:text-blue-500 [&.router-link-active]:bg-blue-500/20">
